...
if __name__ == "__main__":
    ...
    if config.image_size == 64:
        data_loader = CelebALoader(config.data_dir, num_workers=4, actions=celeba_process_actions())
    ...
    if isinstance(clipper_ret, tuple):
        ...
        sampler.set_data_loader(CelebALoader(config.sample_dir, block_size=18, max_blocks=256,
                                        num_workers=2, actions=celeba_process_actions()))
