...
def run_task_eval(config, eval_data_loader,
    ...
    classifier_logits = classifier_forward(config, classifier_inputs, name="image_classifier")
    classifier_variables = [var for var in tf.all_variables() if var.name.startswith("image_classifier")
...
def run_task(config,
    ...
    print(train_data_loader.classes())
